...
local function updateReadouts()
	...
	setText(styleReadout, `Visualizer: {resonance:GetStyle()}`)
...
local function buildUi()
	...
	createLabel(panel, "Title", "ArrayWave Visualizer", 20, palette.SoftWhite)
	...
	local visualRowA = createRow(panel, "VisualizerRowA", 3)
	createButton(visualRowA, "Grid", function()
		context.ResonanceController:SetStyle("Grid")
		UIController:SetStatus("Visualizer: Grid")
	end)
	createButton(visualRowA, "Row", function()
		context.ResonanceController:SetStyle("Row")
		UIController:SetStatus("Visualizer: Row")
	end)
	createButton(visualRowA, "Circle", function()
		context.ResonanceController:SetStyle("Circle")
		UIController:SetStatus("Visualizer: Circle")
	end)

	local visualRowB = createRow(panel, "VisualizerRowB", 3)
	createButton(visualRowB, "All", function()
		context.ResonanceController:SetStyle("All")
		UIController:SetStatus("Visualizer: All")
	end)
	createButton(visualRowB, "Minimal", function()
		context.ResonanceController:SetStyle("Minimal")
		UIController:SetStatus("Visualizer: Minimal")
	end)
	createButton(visualRowB, "Pulse Test", function()
		context.ResonanceController:TriggerPulseTest()
		UIController:SetStatus("Pulse test")
	end)

	local marbleRow = createRow(panel, "MarbleRow", 1)
	createButton(marbleRow, "Drop Marble", function()
	...
	styleReadout = createLabel(panel, "StyleReadout", "Visualizer: Grid", 15, Color3.fromRGB(158, 170, 168))
end
